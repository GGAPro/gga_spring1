	...
	$(".btn_weather_date").click(function(){
		...
		$.getJSON(url, function(data){
			...
			if(weatherIconData == "0" || weatherIconData == "2") { //먼저 짜보고 하자 
				var weatherOutput = "<div id='weather_img'><img src='http://localhost:9000/gga_test1/images/weatherSun.png'></div>";
			}else if(weatherIconData == "1") {
				var weatherOutput = "<div id='weather_img'><img src='http://localhost:9000/gga_test1/images/weatherSun.png'></div>";
			}else if(weathetIconData == "3") {
				var weathetOutput = "<div id='weather_img'><img src='http://localhost:9000/gga_test1/images/weatherCloud.png'></div>"
			}else if(weathetIconData == "4") {
				var weatherOutput = "<div id='weather_img'><img src='http://localhost:9000/gga_test1/images/weatherCloud.png'></div>";
			}
