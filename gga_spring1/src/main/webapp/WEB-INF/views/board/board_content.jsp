...
<script src="http://localhost:9000/gga_spring1/jquery/jquery-3.6.4.min.js"></script>
				...
				<table class="table table-bordered" style="width: 90%;">
					...
					<tr>
						...
						<a href ="board_update.do?bid=${boardVo.bid}">
							<img id="boardUpdate" src="http://localhost:9000/gga_spring1/images/editbtn.png"></a>
							<img id="boardDelete" src="http://localhost:9000/gga_spring1/images/deletebtn.png">
							<a href="board_list.do">
								<img src="http://localhost:9000/gga_spring1/images/listbtn.png"></a>
						</td>				
					</tr>
				</table>
			</form>
