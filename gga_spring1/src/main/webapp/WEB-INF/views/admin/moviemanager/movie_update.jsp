...
<body>
	...
	<div class="board_title">
		...
		<section class="moviemanager">
			<form name="movieUpdate" action="movie_update_proc.do" method="post">
			<table class="table table-bordered" style="width: 90%;">
				<tr>
					<th>영화제목</th>
					<td><input type="text" name="mtitle" id="mtitle" value="${movieVo.mtitle}"></td>
				...
				<tr>
					<td colspan="2">
						<button type="button" id="btnMovieUpdate">수정완료</button>
						<a href="http://localhost:9000/gga_spring1/movie_content.do">
