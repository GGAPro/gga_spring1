...
<body>
	...
	<div class="join_title">
		<img src="http://localhost:9000/gga_spring1/images/jointitle.png">
		</div>
	<section class="join">
			<form name="joinForm" action="joinProc.do" method="post">
				<ul>
					...
					<div class="joinbtn">
						...
						<img src="http://localhost:9000/gga_spring1/images/resetbtn.png"></a>
						<button type="submit" id="btnJoin" class="btnjoinproc">
						<img src="http://localhost:9000/gga_spring1/images/joinbtn2.png" ></button>
					</div>			
			</form>
		</section>
	</div>
