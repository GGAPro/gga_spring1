...
<body>
	...
	<div class="container">
		...
		<img src="http://localhost:9000/gga_spring1/images/ordertitle.png">
		</div>
	...
	<article class="cont-select">
        ...
        <ul class="list-member">
            <li><button type="button" class="orderseltitle" value="MOVIEID_0001">다크 나이트 라이즈</button></li>
            <li><button type="button" class="orderseltitle" value="MOVIEID_0002">스즈메의 문단속</button></li>
            <li><button type="button" class="orderseltitle" value="MOVIEID_0003">듄</button></li>
            <li><button type="button" class="orderseltitle" value="MOVIEID_0004">인셉션</button></li>
            <li><button type="button" class="orderseltitle" value="MOVIEID_0007">반지의 제왕: 왕의 귀환</button></li>
            <li><button type="button" class="orderseltitle" value="MOVIEID_0009">더 퍼스트 슬램덩크</button></li>
        </ul>
    </article>
...
<!-- 		<button type="button" name="orderformbtn" id="orderformbtn">좌석 선택</button>
 -->		
		...
		<img src="http://localhost:9000/gga_spring1/images/seatselbtn.png">
		</div>
