...
<script src="http://localhost:9000/gga_spring1/js/weather_api.js"></script>
	...
	<div class="container text-center">
		<div class="section1">
			...
			<div class="ggamovietitle">
			    <img src="http://localhost:9000/gga_spring1/images/ggamovietitle.png">
			    </div>
		...
		<div class="section2">
		 		<div class="nowtitle">
			    <img src="http://localhost:9000/gga_spring1/images/nowtitle.png">
			    </div>
		 	<div class="row row-cols-1 row-cols-md-5 mb-5 justify-content-center">
		 		<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
				        	<img src="http://localhost:9000/gga_spring1/images/darknight.jpg" 
				        		class="mimg" id="M_0001">
			        	<div class="card-body">
			          	<p class="card-text">다크나이트</p>
			          	<a class="headerorderbtn">
						<img src="http://localhost:9000/gga_spring1/images/neworderbtn.png"></a>
			        	</div>
			     	</div>
		    	</div>
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_spring1/images/dune.jpg" 
			        		class="mimg" id="M_0003">
			        	<div class="card-body">
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_spring1/images/inception.jpg" 
			        		class="mimg" id="M_0004">
			        	<div class="card-body">
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_spring1/images/slamdunk.jpg" 
			        		class="mimg" id="M_0009">
			        	<div class="card-body">
		    	...
		    	<div class="col">
			    	<div class="card mb-4 rounded-3 shadow-sm">
			        	<img src="http://localhost:9000/gga_spring1/images/door.jpg" 
			        		class="mimg" id="M_0002">
			        	<div class="card-body">
			  ...
			  <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel" data-bs-interval="2000">
				  <div class="carousel-inner">
				    <div class="carousel-item active">
				      <img src="http://localhost:9000/gga_spring1/images/bannerimg2.jpg" class="d-block w-100" style="height: 200px;" alt="...">
				    </div>
				  <div class="carousel-item">
				      <img src="http://localhost:9000/gga_spring1/images/bannerimg3.jpg" class="d-block w-100" style="height: 200px;" alt="...">
				  </div>
				    <div class="carousel-item">
				      <img src="http://localhost:9000/gga_spring1/images/footerimg2.jpg" class="d-block w-100" style="height: 200px;" alt="...">
				    </div>
				  </div>
		...
		<div class="section4">
			<div class="row">
			    <div class="mapimg">
			    <img src="http://localhost:9000/gga_spring1/images/map.png">
			    </div>
			</div>
			<div class="row">
				<div class="col-9">
